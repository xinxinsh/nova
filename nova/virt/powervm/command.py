...
class BaseCommand(object):
    ...
    def chhwres(self, args=''):
        return 'chhwres %s' % args
    ...
    def viosvrcmd(self, args=''):
        return 'viosvrcmd %s' % args

    def chlparstate(self, args=''):
        return 'chlparstate %s' % args
...
class HMCCommand(BaseCommand):

    def lsvg(self, args=''):
        return BaseCommand.lsvg(self, args)

    def mklv(self, args=''):
        return BaseCommand.mklv(self, args)

    def rmdev(self, args=''):
        return BaseCommand.rmdev(self, args)

    def rmvdev(self, args=''):
        return BaseCommand.rmvdev(self, args=args)

    def lsmap(self, args=''):
        return BaseCommand.lsmap(self, args)

    def lsdev(self, args=''):
        return BaseCommand.lsdev(self, args)

    def cfgdev(self, args=''):
        return BaseCommand.cfgdev(self, args=args)

    def mkvdev(self, args=''):
        return BaseCommand.mkvdev(self, args=args)

    def hostname(self, args=''):
        return BaseCommand.hostname(self, args=args)

    def viosvrcmd(self, args=''):
        return BaseCommand.viosvrcmd(self, args=args)

    def chhwres(self, args=''):
        return BaseCommand.chhwres(self, args=args)

    def lshwres(self, args=''):
        return BaseCommand.lshwres(self, args=args)

    def chlparstate(self, args=''):
        return BaseCommand.chlparstate(self, args=args)
